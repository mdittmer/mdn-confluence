...
foam.CLASS({
  ...
  imports: [
    ...
    'selectableColumns? as importedSelectableColumns',
    'selectedColumns? as importedSelectedColumns',
  ],
  exports: [
...
`
  ...
  properties: [
    ...
    },
    {
      ...
      factory: function() {
        return this.importedSelectableColumns || this.of.tableColumns ||
    ...
    },
    {
      ...
      factory: function() {
        return this.importedSelectedColumns ||
            Array.from(this.selectableColumns);
      },
    },
    {
